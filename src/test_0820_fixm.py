    ...
    if args.load :
        ...
        if args.add:
            json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
                open('../save/json/with_add/test/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_iid.json'.format(args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #     if args.iid:
        #         json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #         open('../save/json/with_add/add_ep{}/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_iid.json'.format(args.add_ep, args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #         open('../save/json/with_add/add_ep{}/{}/iid/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_iid.json'.format(args.add_ep, args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #     else:
        #         if args.one:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_one.json'.format(args.add_ep,args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/non-iid/one/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_one.json'.format(args.add_ep,args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         elif args.unequal:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_unequal.json'.format(args.add_ep,args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/non-iid/unequal/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_unequal.json'.format(args.add_ep,args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         else:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_two.json'.format(args.add_ep,args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/with_add/add_ep{}/{}/non-iid/two/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_two.json'.format(args.add_ep,args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        # else:
        #     if args.iid:
        #         json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #         open('../save/json/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_iid.json'.format(args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #         open('../save/json/{}/iid/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_iid.json'.format(args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #     else:
        #         if args.one:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_one.json'.format(args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/non-iid/one/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_one.json'.format(args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         elif args.unequal:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_unequal.json'.format(args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/non-iid/unequal/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_unequal.json'.format(args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #         else:
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/{}/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_two.json'.format(args.dataset, args.algo, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
        #             json.dump({'test_accuracy':test_accuracy,'test_loss':test_loss},\
        #             open('../save/json/{}/non-iid/two/{}_{}_round[{}]_C[{}]_Clusters[{}]_E[{}]_B[{}]_two.json'.format(args.dataset, args.algo, args.dataset, first_reach, args.frac,  len(membership.keys()), args.local_ep, args.local_bs),'w'))
